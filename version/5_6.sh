...
export PHP_VERSION="5.6.38"
echo "============ Building PHP version $PHP_VERSION =============="
PHP_BUILD_CONFIGURE_OPTS="--with-bz2 --enable-intl --with-ldap=/usr/include" php-build -i development "$PHP_VERSION" $HOME/.phpenv/versions/5.6
